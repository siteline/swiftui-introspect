...
///             .introspect(.datePicker(style: .compact), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27)) {
...
///         DatePicker("Pick a date", selection: $date)
///             .datePickerStyle(.compact)
///             .introspect(.datePicker(style: .compact), on: .macOS(.v10_15_4, .v11, .v12, .v13, .v14, .v15, .v26, .v27)) {
...
///         DatePicker("Pick a date", selection: $date)
///             .datePickerStyle(.compact)
///             .introspect(.datePicker(style: .compact), on: .visionOS(.v1, .v2, .v26, .v27)) {
///                 print(type(of: $0)) // UIDatePicker
///             }
///     }
/// }
