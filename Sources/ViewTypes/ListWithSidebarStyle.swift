...
///         }
///         .introspect(.list(style: .sidebar), on: .iOS(.v16, .v17, .v18, .v26, .v27)) {
...
///         }
///         .listStyle(.sidebar)
///         .introspect(.list(style: .sidebar), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26, .v27)) {
...
///         }
///         .listStyle(.sidebar)
///         .introspect(.list(style: .sidebar), on: .visionOS(.v1, .v2, .v26, .v27)) {
///             print(type(of: $0)) // UICollectionView
///         }
///     }
/// }
