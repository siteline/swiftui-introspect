...
///             Text("Root")
///         }
///         .introspect(.navigationStack, on: .iOS(.v16, .v17, .v18, .v26, .v27)) {
...
///             Text("Root")
///         }
///         .introspect(.navigationStack, on: .tvOS(.v16, .v17, .v18, .v26, .v27)) {
///             print(type(of: $0)) // UINavigationController
///         }
///     }
/// }
...
///             Text("Root")
///         }
///         .introspect(.navigationStack, on: .visionOS(.v1, .v2, .v26, .v27)) {
///             print(type(of: $0)) // UINavigationController
///         }
///     }
/// }
