...
///             .introspect(.progressView(style: .circular), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27)) {
...
///         ProgressView(value: 0.5)
///             .progressViewStyle(.circular)
///             .introspect(.progressView(style: .circular), on: .tvOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27)) {
///                 print(type(of: $0)) // UIActivityIndicatorView
///             }
///     }
/// }
...
///         ProgressView(value: 0.5)
///             .progressViewStyle(.circular)
///             .introspect(.progressView(style: .circular), on: .macOS(.v11, .v12, .v13, .v14, .v15, .v26, .v27)) {
...
///         ProgressView(value: 0.5)
///             .progressViewStyle(.circular)
///             .introspect(.progressView(style: .circular), on: .visionOS(.v1, .v2, .v26, .v27)) {
///                 print(type(of: $0)) // UIActivityIndicatorView
///             }
///     }
/// }
