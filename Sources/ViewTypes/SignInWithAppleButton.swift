...
///         }
///         .introspect(.signInWithAppleButton, on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27)) {
...
///             // do something with result
///         }
///         .introspect(.signInWithAppleButton, on: .tvOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27)) {
///             print(type(of: $0)) // ASAuthorizationAppleIDButton
///         }
///     }
/// }
...
///             // do something with result
///         }
///         .introspect(.signInWithAppleButton, on: .macOS(.v11, .v12, .v13, .v14, .v15, .v26, .v27),) {
///             print(type(of: $0)) // ASAuthorizationAppleIDButton
///         }
///     }
/// }
...
///             // do something with result
///         }
///         .introspect(.signInWithAppleButton, on: .visionOS(.v1, .v2, .v26, .v27)) {
///             print(type(of: $0)) // ASAuthorizationAppleIDButton
///         }
///     }
/// }
