        ...
        XCTAssertViewIntrospection(of: PlatformDatePicker.self) { spies in
            ...
            VStack {
                DatePicker("", selection: .constant(date0))
                    ...
                    .introspect(.datePicker, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy0)
                    #elseif os(macOS)
                    .introspect(.datePicker, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26), customize: spy0)
                    #endif
                    .cornerRadius(8)

                DatePicker("", selection: .constant(date1))
                    #if os(iOS) || os(visionOS)
                    .introspect(.datePicker, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy1)
                    #elseif os(macOS)
                ...
                DatePicker("", selection: .constant(date2))
                    #if os(iOS) || os(visionOS)
                    .introspect(.datePicker, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy2)
                    #elseif os(macOS)
