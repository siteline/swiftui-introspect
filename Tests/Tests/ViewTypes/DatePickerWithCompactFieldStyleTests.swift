		...
		let (entity1, entity2, entity3) = try await introspection(of: PlatformDatePickerWithCompactStyle.self) { spy1, spy2, spy3 in
			VStack {
				DatePicker("", selection: .constant(date1))
					...
					.introspect(.datePicker(style: .compact), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27), .visionOS(.v1, .v2, .v26, .v27), customize: spy1)
					#elseif os(macOS)
					.introspect(.datePicker(style: .compact), on: .macOS(.v10_15_4, .v11, .v12, .v13, .v14, .v15, .v26, .v27), customize: spy1)
					#endif
					.cornerRadius(8)
				...
				DatePicker("", selection: .constant(date2))
					.datePickerStyle(.compact)
					#if os(iOS) || os(visionOS)
					.introspect(.datePicker(style: .compact), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27), .visionOS(.v1, .v2, .v26, .v27), customize: spy2)
					#elseif os(macOS)
					.introspect(.datePicker(style: .compact), on: .macOS(.v10_15_4, .v11, .v12, .v13, .v14, .v15, .v26, .v27), customize: spy2)
					#endif
					.cornerRadius(8)
				...
				DatePicker("", selection: .constant(date3))
					.datePickerStyle(.compact)
					#if os(iOS) || os(visionOS)
					.introspect(.datePicker(style: .compact), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26, .v27), .visionOS(.v1, .v2, .v26, .v27), customize: spy3)
					#elseif os(macOS)
					.introspect(.datePicker(style: .compact), on: .macOS(.v10_15_4, .v11, .v12, .v13, .v14, .v15, .v26, .v27), customize: spy3)
					#endif
			}
		}
		#if canImport(UIKit)
