        ...
        XCTAssertViewIntrospection(of: PlatformDatePickerWithCompactStyle.self) { spies in
            ...
            VStack {
                DatePicker("", selection: .constant(date0))
                    ...
                    .introspect(.datePicker(style: .compact), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy0)
                    #elseif os(macOS)
                    .introspect(.datePicker(style: .compact), on: .macOS(.v10_15_4, .v11, .v12, .v13, .v14, .v15, .v26), customize: spy0)
                    #endif
                    .cornerRadius(8)
                ...
                DatePicker("", selection: .constant(date1))
                    .datePickerStyle(.compact)
                    #if os(iOS) || os(visionOS)
                    .introspect(.datePicker(style: .compact), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy1)
                    #elseif os(macOS)
                ...
                DatePicker("", selection: .constant(date2))
                    .datePickerStyle(.compact)
                    #if os(iOS) || os(visionOS)
                    .introspect(.datePicker(style: .compact), on: .iOS(.v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy2)
                    #elseif os(macOS)
