        ...
        XCTAssertViewIntrospection(of: PlatformDatePickerWithGraphicalStyle.self) { spies in
            ...
            VStack {
                DatePicker("", selection: .constant(date0))
                    ...
                    #elseif os(macOS)
                    .introspect(.datePicker(style: .graphical), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy0)
                    #endif
                    .cornerRadius(8)
                ...
                DatePicker("", selection: .constant(date1))
                    ...
                    #elseif os(macOS)
                    .introspect(.datePicker(style: .graphical), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy1)
                    #endif
                    .cornerRadius(8)
                ...
                DatePicker("", selection: .constant(date2))
                    ...
                    #elseif os(macOS)
                    .introspect(.datePicker(style: .graphical), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy2)
                    #endif
            }
        } extraAssertions: {
            #if canImport(UIKit)
