    ...
    func testFormWithGroupedStyle() throws {
        ...
        XCTAssertViewIntrospection(of: PlatformFormWithGroupedStyle.self) { spies in
            ...
            HStack {
                ...
                .introspect(.form(style: .grouped), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2)) { spy0($0) }
                ...
                Form {
                    Text("Item 1")
                    #if os(iOS) || os(tvOS) || os(visionOS)
                    .introspect(.form(style: .grouped), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2), scope: .ancestor) { spy1($0) }
