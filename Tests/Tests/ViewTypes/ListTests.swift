    ...
    func testList() {
        XCTAssertViewIntrospection(of: PlatformList.self) { spies in
            ...
            HStack {
                ...
                .introspect(.list, on: .iOS(.v16, .v17, .v18), .visionOS(.v1)) { spy0($0) }
                #elseif os(macOS)
                ...
                List {
                    ...
                    .introspect(.list, on: .iOS(.v16, .v17, .v18), .visionOS(.v1), scope: .ancestor) { spy1($0) }
                    #elseif os(macOS)
    ...
    func testNestedList() {
        XCTAssertViewIntrospection(of: PlatformList.self) { spies in
            ...
            List {
                ...
                .introspect(.list, on: .iOS(.v16, .v17, .v18), .visionOS(.v1)) { spy1($0) }
                #endif
            }
            #if os(iOS) || os(tvOS) || os(visionOS)
            .introspect(.list, on: .iOS(.v13, .v14, .v15), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18)) { spy0($0) }
