    ...
    func testListWithInsetGroupedStyle() throws {
        ...
        XCTAssertViewIntrospection(of: PlatformListWithInsetGroupedStyle.self) { spies in
            ...
            HStack {
                ...
                .introspect(.list(style: .insetGrouped), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2, .v26)) { spy0($0) }
                #endif
                ...
                List {
                    ...
                    .introspect(.list(style: .insetGrouped), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2, .v26), scope: .ancestor) { spy1($0) }
                    #endif
                }
                .listStyle(.insetGrouped)
            }
