    ...
    func testListWithInsetStyle() throws {
        ...
        XCTAssertViewIntrospection(of: PlatformListWithInsetStyle.self) { spies in
            ...
            HStack {
                ...
                .introspect(.list(style: .inset), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2)) { spy0($0) }
                #elseif os(macOS)
                ...
                List {
                    ...
                    .introspect(.list(style: .inset), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2), scope: .ancestor) { spy1($0) }
                    #elseif os(macOS)
