	...
	@Test func introspect() async throws {
		let (entity1, entity2) = try await introspection(of: PlatformListWithInsetStyle.self) { spy1, spy2 in
			HStack {
				...
				.introspect(.list(style: .inset), on: .iOS(.v16, .v17, .v18, .v26, .v27), .visionOS(.v1, .v2, .v26, .v27), customize: spy1)
				#elseif os(macOS)
				.introspect(.list(style: .inset), on: .macOS(.v11, .v12, .v13, .v14, .v15, .v26, .v27), customize: spy1)
				#endif
				...
				List {
					Text("Item 1")
						...
						.introspect(.list(style: .inset), on: .iOS(.v16, .v17, .v18, .v26, .v27), .visionOS(.v1, .v2, .v26, .v27), scope: .ancestor, customize: spy2)
						#elseif os(macOS)
						.introspect(.list(style: .inset), on: .macOS(.v11, .v12, .v13, .v14, .v15, .v26, .v27), scope: .ancestor, customize: spy2)
						#endif
				}
				.listStyle(.inset)
			}
