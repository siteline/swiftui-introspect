	...
	@Test func introspect() async throws {
		let (entity1, entity2) = try await introspection(of: PlatformListWithSidebarStyle.self) { spy1, spy2 in
			HStack {
				...
				.introspect(.list(style: .sidebar), on: .iOS(.v16, .v17, .v18, .v26, .v27), .visionOS(.v1, .v2, .v26, .v27), customize: spy1)
				#elseif os(macOS)
				.introspect(.list(style: .sidebar), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26, .v27), customize: spy1)
				#endif
				...
				List {
					Text("Item 1")
						...
						.introspect(.list(style: .sidebar), on: .iOS(.v16, .v17, .v18, .v26, .v27), .visionOS(.v1, .v2, .v26, .v27), scope: .ancestor, customize: spy2)
						#elseif os(macOS)
						.introspect(.list(style: .sidebar), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26, .v27), scope: .ancestor, customize: spy2)
						#endif
				}
				.listStyle(.sidebar)
			}
