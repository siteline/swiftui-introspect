    ...
    func testListWithSidebarStyle() throws {
        ...
        XCTAssertViewIntrospection(of: PlatformListWithSidebarStyle.self) { spies in
            ...
            HStack {
                ...
                #elseif os(macOS)
                .introspect(.list(style: .sidebar), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15)) { spy0($0) }
                #endif
                ...
                List {
                    ...
                    #elseif os(macOS)
                    .introspect(.list(style: .sidebar), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), scope: .ancestor) { spy1($0) }
                    #endif
                }
                .listStyle(.sidebar)
            }
