    ...
    func testListWithSidebarStyle() throws {
        ...
        XCTAssertViewIntrospection(of: PlatformListWithSidebarStyle.self) { spies in
            ...
            HStack {
                ...
                .introspect(.list(style: .sidebar), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2, .v26)) { spy0($0) }
                #elseif os(macOS)
                .introspect(.list(style: .sidebar), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26)) { spy0($0) }
                #endif
                ...
                List {
                    ...
                    .introspect(.list(style: .sidebar), on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2, .v26), scope: .ancestor) { spy1($0) }
                    #elseif os(macOS)
                    .introspect(.list(style: .sidebar), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26), scope: .ancestor) { spy1($0) }
                    #endif
                }
                .listStyle(.sidebar)
            }
