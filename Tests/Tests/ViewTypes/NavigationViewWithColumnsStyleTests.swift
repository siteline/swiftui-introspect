...
final class NavigationViewWithColumnsStyleTests: XCTestCase {
    ...
    func testNavigationViewWithColumnsStyle() {
        XCTAssertViewIntrospection(of: PlatformNavigationViewWithColumnsStyle.self) { spies in
            ...
            .introspect(.navigationView(style: .columns), on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18), .visionOS(.v1), customize: spy)
            #elseif os(tvOS)
        ...
        XCTAssertViewIntrospection(of: PlatformNavigationViewWithColumnsStyle.self) { spies in
            ...
            NavigationView {
                ZStack {
                    ...
                    Text("Something")
                        #if os(iOS) || os(visionOS)
                        .introspect(.navigationView(style: .columns), on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18), .visionOS(.v1), scope: .ancestor, customize: spy)
                        #elseif os(tvOS)
