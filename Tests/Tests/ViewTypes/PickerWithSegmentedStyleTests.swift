    ...
    func testPickerWithSegmentedStyle() {
        XCTAssertViewIntrospection(of: PlatformPickerWithSegmentedStyle.self) { spies in
            ...
            VStack {
                ...
                .introspect(.picker(style: .segmented), on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy0)
                #elseif os(macOS)
                ...
                .pickerStyle(.segmented)
                #if os(iOS) || os(tvOS) || os(visionOS)
                .introspect(.picker(style: .segmented), on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy1)
                #elseif os(macOS)
                ...
                .pickerStyle(.segmented)
                #if os(iOS) || os(tvOS) || os(visionOS)
                .introspect(.picker(style: .segmented), on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy2)
                #elseif os(macOS)
