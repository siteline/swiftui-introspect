    ...
    func testPickerWithSegmentedStyle() {
        XCTAssertViewIntrospection(of: PlatformPickerWithSegmentedStyle.self) { spies in
            ...
            VStack {
                ...
                #elseif os(macOS)
                .introspect(.picker(style: .segmented), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy0)
                #endif
                .cornerRadius(8)
                ...
                #elseif os(macOS)
                .introspect(.picker(style: .segmented), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy1)
                #endif
                .cornerRadius(8)
                ...
                #elseif os(macOS)
                .introspect(.picker(style: .segmented), on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy2)
                #endif
            }
        } extraAssertions: {
            #if canImport(UIKit)
