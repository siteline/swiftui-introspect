        ...
        XCTAssertViewIntrospection(of: PlatformProgressViewWithLinearStyle.self) { spies in
            ...
            VStack {
                ProgressView(value: 0.25)
                    ...
                    #elseif os(macOS)
                    .introspect(.progressView(style: .linear), on: .macOS(.v11, .v12, .v13, .v14, .v15), customize: spy0)
                    #endif
                ...
                ProgressView(value: 0.5)
                    ...
                    #elseif os(macOS)
                    .introspect(.progressView(style: .linear), on: .macOS(.v11, .v12, .v13, .v14, .v15), customize: spy1)
                    #endif
                ...
                ProgressView(value: 0.75)
                    ...
                    #elseif os(macOS)
                    .introspect(.progressView(style: .linear), on: .macOS(.v11, .v12, .v13, .v14, .v15), customize: spy2)
                    #endif
            }
        } extraAssertions: {
            #if canImport(UIKit)
