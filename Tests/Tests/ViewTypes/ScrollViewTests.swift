    ...
    func testScrollView() {
        XCTAssertViewIntrospection(of: PlatformScrollView.self) { spies in
            ...
            HStack {
                ...
                .introspect(.scrollView, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18), .visionOS(.v1), customize: spy0)
                #elseif os(macOS)
                ...
                ScrollView(showsIndicators: true) {
                    Text("Item 1")
                    #if os(iOS) || os(tvOS) || os(visionOS)
                    .introspect(.scrollView, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18), .visionOS(.v1), scope: .ancestor, customize: spy1)
                    #elseif os(macOS)
    ...
    func testNestedScrollView() {
        XCTAssertViewIntrospection(of: PlatformScrollView.self) { spies in
            ...
            ScrollView(showsIndicators: true) {
                ...
                #if os(iOS) || os(tvOS) || os(visionOS)
                .introspect(.scrollView, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18), .visionOS(.v1), customize: spy1)
                #elseif os(macOS)
