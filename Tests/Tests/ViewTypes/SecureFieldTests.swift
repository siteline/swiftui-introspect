        ...
        XCTAssertViewIntrospection(of: PlatformSecureField.self) { spies in
            ...
            VStack {
                SecureField("", text: .constant("Secure Field 0"))
                    ...
                    .introspect(.secureField, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy0)
                    #elseif os(macOS)
                    .introspect(.secureField, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26), customize: spy0)
                    #endif
                    .cornerRadius(8)

                SecureField("", text: .constant("Secure Field 1"))
                    #if os(iOS) || os(tvOS) || os(visionOS)
                    .introspect(.secureField, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy1)
                    #elseif os(macOS)
                ...
                SecureField("", text: .constant("Secure Field 2"))
                    #if os(iOS) || os(tvOS) || os(visionOS)
                    .introspect(.secureField, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy2)
                    #elseif os(macOS)
