        ...
        XCTAssertViewIntrospection(of: PlatformTable.self) { spies in
            ...
            VStack {
                TipTable()
                    ...
                    #elseif os(macOS)
                    .introspect(.table, on: .macOS(.v12, .v13, .v14, .v15), customize: spy0)
                    #endif
                ...
                TipTable()
                    ...
                    #elseif os(macOS)
                    .introspect(.table, on: .macOS(.v12, .v13, .v14, .v15), customize: spy1)
                    #endif
                ...
                TipTable()
                    ...
                    #elseif os(macOS)
                    .introspect(.table, on: .macOS(.v12, .v13, .v14, .v15), customize: spy2)
                    #endif
            }
        }
    }
