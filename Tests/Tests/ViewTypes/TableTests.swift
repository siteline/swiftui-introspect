        ...
        XCTAssertViewIntrospection(of: PlatformTable.self) { spies in
            ...
            VStack {
                TipTable()
                    ...
                    .introspect(.table, on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy0)
                    #elseif os(macOS)
                ...
                TipTable()
                    #if os(iOS) || os(visionOS)
                    .introspect(.table, on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy1)
                    #elseif os(macOS)
                ...
                TipTable()
                    #if os(iOS) || os(visionOS)
                    .introspect(.table, on: .iOS(.v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy2)
                    #elseif os(macOS)
