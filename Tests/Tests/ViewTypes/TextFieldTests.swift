        ...
        XCTAssertViewIntrospection(of: PlatformTextField.self) { spies in
            ...
            VStack {
                TextField("", text: .constant("Text Field 0"))
                    ...
                    #elseif os(macOS)
                    .introspect(.textField, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy0)
                    #endif
                    .cornerRadius(8)
                ...
                TextField("", text: .constant("Text Field 1"))
                    ...
                    #elseif os(macOS)
                    .introspect(.textField, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy1)
                    #endif
                    .cornerRadius(8)
                ...
                TextField("", text: .constant("Text Field 2"))
                    ...
                    #elseif os(macOS)
                    .introspect(.textField, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy2)
                    #endif
            }
        } extraAssertions: {
            #if canImport(UIKit)
