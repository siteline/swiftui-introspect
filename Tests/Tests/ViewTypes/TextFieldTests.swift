        ...
        XCTAssertViewIntrospection(of: PlatformTextField.self) { spies in
            ...
            VStack {
                TextField("", text: .constant("Text Field 0"))
                    ...
                    .introspect(.textField, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy0)
                    #elseif os(macOS)
                ...
                TextField("", text: .constant("Text Field 1"))
                    #if os(iOS) || os(tvOS) || os(visionOS)
                    .introspect(.textField, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy1)
                    #elseif os(macOS)
                ...
                TextField("", text: .constant("Text Field 2"))
                    #if os(iOS) || os(tvOS) || os(visionOS)
                    .introspect(.textField, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy2)
                    #elseif os(macOS)
