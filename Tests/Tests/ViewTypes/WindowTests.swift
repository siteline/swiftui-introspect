        ...
        XCTAssertViewIntrospection(of: PlatformWindow.self) { spies in
            ...
            VStack {
                Image(systemName: "scribble")
                    ...
                    #elseif os(macOS)
                    .introspect(.window, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy0)
                    #endif
                ...
                Text("Text")
                    ...
                    #elseif os(macOS)
                    .introspect(.window, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy1)
                    #endif
            }
            #if os(iOS) || os(tvOS) || os(visionOS)
            .introspect(.window, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18), .visionOS(.v1, .v2), customize: spy2)
            #elseif os(macOS)
            .introspect(.window, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15), customize: spy2)
            #endif
        } extraAssertions: {
