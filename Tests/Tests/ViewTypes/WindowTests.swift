        ...
        XCTAssertViewIntrospection(of: PlatformWindow.self) { spies in
            ...
            VStack {
                Image(systemName: "scribble")
                    ...
                    .introspect(.window, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy0)
                    #elseif os(macOS)
                ...
                Text("Text")
                    #if os(iOS) || os(tvOS) || os(visionOS)
                    .introspect(.window, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy1)
                    #elseif os(macOS)
                    .introspect(.window, on: .macOS(.v10_15, .v11, .v12, .v13, .v14, .v15, .v26), customize: spy1)
                    #endif
            }
            #if os(iOS) || os(tvOS) || os(visionOS)
            .introspect(.window, on: .iOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .tvOS(.v13, .v14, .v15, .v16, .v17, .v18, .v26), .visionOS(.v1, .v2), customize: spy2)
            #elseif os(macOS)
